...
var _imageController = __webpack_require__(335);

(0, _imageController.imageController)();
...
exports.imageController = undefined;

var _imageView = __webpack_require__(336);

var _imagesList = __webpack_require__(337);

const imageController = () => {

    (0, _imageView.imageView)('#images-list', _imagesList.imagesList);
};
...
const imageView = (selector, imageView) => {

    const list = document.querySelector(selector);

    if (list) {
        const imageDraw = (url, i) => {
...
const imagesList = ['http://travel.home.sndimg.com/content/dam/images/travel/fullset/2015/08/21/best-beaches-juno-florida.jpg.rend.hgtvcom.616.462.suffix/1491580936376.jpeg', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGG7_OA17iq4cMYfuHRVvdC8yR4YXhs8dNATG00Kb01GZ_slYU', 'https://static.pexels.com/photos/248797/pexels-photo-248797.jpeg', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPGqhPPCXbyCRlN80VBagsEnVf0Azw85MkNsX4yPAhmVelzIyk', 'https://thumbs.dreamstime.com/b/beach-background-beautiful-beach-landscape-tropical-nature-scene-palm-trees-blue-sky-summer-holiday-vacation-concept-93726413.jpg'];
...
var _guitarController = __webpack_require__(339);

(0, _guitarController.guitarController)();
...
exports.guitarController = undefined;

var _guitarView = __webpack_require__(340);

var _guitarList = __webpack_require__(341);

const guitarController = () => {

    (0, _guitarView.guitarView)('#guitar-list', _guitarList.guitarList);
};

exports.guitarController = guitarController;
...
const setElementsCords = (parent, child) => {
...
const guitarView = (selector, guitarList) => {
    const list = document.querySelector(selector);
...
const guitarList = [{
    ...
    url: 'https://tympanus.net/Development/ExpandingGridItemAnimation/img/1.png'
}, {
    title: 'Space Fantasy',
    subtitle: 'DANICA GREEN',
    price: 199,
    description: 'Man bun banjo pop-up meh hammock. Skateboard hammock tousled retro, etsy taiyaki narwhal gentrify fixie food truck microdosing sustainable dreamcatcher.',
    url: 'https://tympanus.net/Development/ExpandingGridItemAnimation/img/2.png'
}];

exports.guitarList = guitarList;
